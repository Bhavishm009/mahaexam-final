...
async function verify() {
  ...
  console.log("\nLive Exams:");
  liveExams.forEach(e => console.log(`  🟢 [LIVE] ${e.slug} (${e.totalQuestions} Qs) - ${e.title}`));
  ...
  console.log(`  Option 1: ${positionCounts[1]} times (${((positionCounts[1]/100)*100).toFixed(1)}%)`);
  console.log(`  Option 2: ${positionCounts[2]} times (${((positionCounts[2]/100)*100).toFixed(1)}%)`);
  console.log(`  Option 3: ${positionCounts[3]} times (${((positionCounts[3]/100)*100).toFixed(1)}%)`);
  console.log(`  Option 4: ${positionCounts[4]} times (${((positionCounts[4]/100)*100).toFixed(1)}%)`);
