...
function generate100Questions(examType, examIndex) {
  const questions = [];
  ...
  const marathiTopics = [
    ...
    },
    {
      template: (i) => ({
        ...
        options: [
          [
            "प्रत्यक्ष काम न करता दुरूनच सूचना देणे",
            "जवळची वस्तू सोडून दूर शोधणे",
            "अति हुशारीमुळे नुकसान होणे",
            "अंगी कमी गुण असलेला मनुष्य जास्त बडबड करतो",
            "काम संपताच उपकारकर्त्याला विसरणे",
            "बाहेरून चांगले दिसणे पण प्रत्यक्षात वाईट असणे",
            "केलेला उपदेश वाया जाणे",
            "वेळ कमी आणि कामे खूप असणे",
            "शांत बसणे",
            "निश्चित लाभ सोडून अनिश्चित गोष्टीच्या मागे लागणे",
            "अपेक्षेपेक्षा जास्त लाभ होणे",
            "तीव्र इच्छा असेल तर मार्ग निघतो",
            "अतिशय उतावीळ होणे",
            "दोन्ही बाजूंचा दोष असणे",
            "न मिळालेल्या गोष्टीला नावे ठेवणे",
            "सर्वत्र सारखीच परिस्थिती असणे",
            "स्वतः चूक करून दुसऱ्याला दोष देणे",
            "गुपित उघड न करणे",
            "पैशाने सर्व कामे साध्य होतात",
            "स्वतःतील उणीव लपवण्यासाठी दुसऱ्या वस्तूला दोष देणे",
          ][i % 20],
          "फार मोठी मदत करणे",
          "अतिशय आळशी असणे",
          "कोणतेही काम न करणे",
    ...
    },
    {
      template: (i) => {
        ...
        return {
          ...
          options: [
            `${ans} दिवस`,
            `${(Number(ans) + 1).toFixed(1)} दिवस`,
            `${(Number(ans) - 1).toFixed(1)} दिवस`,
            `${(Number(ans) + 2).toFixed(1)} दिवस`,
          ],
          correct: 0,
...
async function main() {
  console.warn("🌱 Starting Enterprise Production Database Seeding...");
  ...
  const bhavishAdmin = await prisma.user.upsert({
  ...
  console.warn(`✅ Super Admin: ${bhavishAdmin.email}`);
  ...
  const subjectsData = [
    ...
    {
      name: "Maharashtra & India GK",
      nameMr: "सामान्य ज्ञान (GK & GS)",
    ...
    { name: "Geography of Maharashtra", nameMr: "महाराष्ट्राचा भूगोल", slug: "geography" },
    {
      ...
      nameMr: "भारतीय राज्यघटना व पंचायत राज",
      slug: "constitution",
    },
  ...
  // 5. Build 10 Police Bharti Exams + Other Major Exams = 25+ Full Free Global Mock Exams
  const examsMeta = [
    // 10 Maharashtra Police Bharti Full Mock Tests
    ...Array.from({ length: 10 }, (_, i) => ({
      ...
      instructionsMr:
        "१. वेळ ९० मिनिटे.\n२. एकूण १०० प्रश्न, प्रत्येकी १ गुण.\n३. निगेटिव्ह मार्किंग नाही.\n४. १००% मोफत व सर्व विद्यार्थ्यांसाठी लाइव्ह.",
    })),

    // 5 Maharashtra Talathi Bharti Full Mock Tests (TCS Pattern)
    ...Array.from({ length: 5 }, (_, i) => ({
      ...
      instructionsMr: "१. वेळ १२० मिनिटे.\n२. मराठी, इंग्रजी, गणित/बुद्धिमत्ता व चालू घडामोडी.",
    })),

    // 2 MPSC Rajyaseva GS Mock Tests
    ...Array.from({ length: 2 }, (_, i) => ({
      ...
      instructionsMr: "१. वेळ २ तास.\n२. १/४ निगेटिव्ह मार्किंग.",
    })),

    // 2 MPSC Group B & C (Combine) Mock Tests
    ...Array.from({ length: 2 }, (_, i) => ({
      ...
      instructionsMr: "१. वेळ ६० मिनिटे.\n२. १/४ निगेटिव्ह मार्किंग.",
    })),

    // 2 Zilla Parishad Mock Tests
    ...Array.from({ length: 2 }, (_, i) => ({
      ...
      instructionsMr: "१. वेळ ९० मिनिटे.\n२. सर्व विद्यार्थ्यांसाठी मोफत.",
    })),

    // 2 Vanrakshak (Forest Guard) Mock Tests
    ...Array.from({ length: 2 }, (_, i) => ({
    ...
    // 2 Saralseva Special Mock Tests
    ...Array.from({ length: 2 }, (_, i) => ({
      ...
      instructionsMr: "१. ९० मिनिटे वेळ.",
    })),

    // 2 TCS/IBPS Quantitative & Reasoning Mock Tests
    ...Array.from({ length: 2 }, (_, i) => ({
  ...
  console.warn(
    `🚀 Seeding ${examsMeta.length} Global Free Live Exams (100 Questions each = ${examsMeta.length * 100} Total Questions)...`,
  );
  ...
  for (let idx = 0; idx < examsMeta.length; idx++) {
    ...
    console.warn(`📚 [${idx + 1}/${examsMeta.length}] Seeding: ${meta.slug}`);
  ...
  // 6. Practice Notification
  await prisma.notification.create({
    data: {
      title: "🎯 महाराष्ट्र पोलीस भरती १० नवीन सराव पेपर्स उपलब्ध!",
      message:
        "महाराष्ट्र पोलीस भरती २०२५ साठी १०० प्रश्नांचे १० पूर्ण सराव संच आणि इतर सर्व परीक्षांचे पेपर्स लाइव्ह झाले आहेत. आताच सराव सुरू करा!",
      type: "FREE_EXAM",
  ...
  console.warn(
    "🎉 Database Seeding Finished: All 27 Live Exams (2,700 Questions) are 100% Live & Free!",
  );
}
