...
// Helper function to shuffle options randomly (so answer is not always at position 1)
...
function generate100Questions(examType, examIndex) {
  ...
  // 1. History of Maharashtra & India
  ...
  // 2. Geography of Maharashtra & India
    ...
    (i) => {
      const items = [
        ...
        },
        {
          ...
          expMr: "डॉ. आंबेडकरांनी कलम ३२ ला 'घटनेचा आत्मा आणि हृदय' म्हटले आहे.",
        },
        {
      ...
      const items = [
        {
          ...
          expMr: "ज्या सामासिक शब्दातील पहिले पद मुख्य असते त्यास अव्ययीभाव समास म्हणतात.",
        },
        {
          ...
          expMr: "कर्ता व कर्म दोघांनाही प्रत्यय असल्यामुळे हा भावे प्रयोग आहे.",
        },
        {
          ...
          expMr: "व्यंजन संधीच्या नियमानुसार सत् + जन = सज्जन.",
        },
        {
          ...
          expMr: "स्वतःजवळ असणारी वस्तू सर्वत्र शोधणे म्हणजे काखेत कळसा गावाला वळसा.",
        },
        {
          ...
          expMr: "मराठीत 'ह' हा मुख्य महाप्राण वर्ण आहे.",
        },
      ];
      const item = items[i % items.length];
      return {
      ...
      const items = [
        {
          ...
          expMr: "Autobiography म्हणजे आत्मचरित्र.",
        },
        {
          ...
          expMr: "Transparent = पारदर्शक, Opaque = अपारदर्शक.",
        },
        {
          ...
          expMr: "Past Indefinite Passive: was/were + V3.",
        },
      ];
      const item = items[i % items.length];
      return {
  ...
  const mathsTemplates = [
    ...
    (i) => {
      ...
      return {
        ...
        expMr: `विक्री किंमत = ${cp} + (${cp} × ${profit} / १००) = ₹${sp}.`,
      };
    },
  ];
  ...
  const reasoningTemplates = [
    (i) => {
      ...
      return {
        ...
        expMr: `फरक (+${diff}) असल्याने पुढील पद ${next} येईल.`,
      };
    },
    (i) => {
      const items = [
      ...
      const items = [
        {
          ...
          expMr: "जीवनसत्त्व 'अ' च्या अभावामुळे रातांधळेपणा होतो.",
        },
        {
          ...
          expMr: "तंतुकणिकांमध्ये ATP स्वरूपात ऊर्जा तयार होते.",
        },
      ];
      const item = items[i % items.length];
      return {
  ...
  // Distribute 100 questions across topics:
...
async function main() {
  ...
  // 5. 27 Exams Blueprint: EXACTLY 10 LIVE EXAMS + 17 DRAFT EXAMS
  const examsMeta = [
  ...
  console.warn(`🚀 Seeding ${examsMeta.length} Exams (10 LIVE, 17 DRAFT) with 100 Questions Each...`);

  for (let idx = 0; idx < examsMeta.length; idx++) {
    const meta = examsMeta[idx];
    const questions100 = generate100Questions(meta.examType, idx);

    console.warn(`📚 [${idx + 1}/${examsMeta.length}] Seeding: ${meta.slug} [Status: ${meta.status}]`);
    ...
    await prisma.examQuestionSnapshot.deleteMany({
      where: { examId: exam.id },
    });
  ...
  console.warn(
    "🎉 Database Seeding Finished: 10 LIVE Exams and 17 Draft Exams created with Randomized Answer Keys!",
  );
}
