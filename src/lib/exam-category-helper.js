export const EXAM_CATEGORIES = [
  {
    slug: "police-bharti",
    id: "POLICE",
    titleMr: "महाराष्ट्र पोलीस भरती परीक्षा २०२६",
    titleEn: "Maharashtra Police Bharti Exam 2026",
    descriptionMr:
      "पोलीस शिपाई, चालक, आणि कारागृह रक्षक पद भरतीसाठी TCS/IBPS पॅटर्नवर आधारित परिपूर्ण ऑनलाइन सराव परीक्षा संच.",
    descriptionEn:
  ...
  },
  {
    slug: "mpsc",
    id: "MPSC",
    titleMr: "MPSC राज्यसेवा व संयुक्त गट ब-क परीक्षा",
    titleEn: "MPSC Rajyaseva & Combine Group B-C Exam",
    descriptionMr:
      "एमपीएससी राज्यसेवा, संयुक्त पूर्व परीक्षा (PSI, STI, ASO) करीता नवीनतम अभ्यासक्रमावर आधारित गुणवत्तापूर्ण सराव चाचण्या.",
    descriptionEn:
  ...
  },
  {
    slug: "talathi",
    id: "TALATHI",
    titleMr: "तलाठी भरती TCS पॅटर्न सराव परीक्षा",
    titleEn: "Talathi Bharti TCS Pattern Mock Tests",
    descriptionMr:
      "TCS आणि IBPS पॅटर्ननुसार मराठी, इंग्रजी, गणित व सामान्य ज्ञान विषयांचे सविस्तर सराव पेपर्स व विश्लेषण.",
    descriptionEn:
  ...
  },
  {
    slug: "zp-bharti",
    id: "ZP",
    titleMr: "जिल्हा परिषद व आरोग्य सेवक भरती",
    titleEn: "Zilla Parishad & Arogya Sevak Mock Tests",
    descriptionMr:
      "जिल्हा परिषद आरोग्य सेवक, ग्रामसेवक, वरिष्ठ सहाय्यक व तांत्रिक पदांसाठी ऑनलाईन CBT सराव टेस्ट्स.",
    descriptionEn:
  ...
  },
  {
    slug: "vanrakshak",
    id: "VANRAKSHAK",
    titleMr: "वनरक्षक व वन विभाग सराव परीक्षा",
    titleEn: "Vanrakshak (Forest Guard) Mock Tests",
    descriptionMr:
      "महाराष्ट्र वन विभाग वनरक्षक भरती ऑनलाईन CBT सराव चाचण्या, पर्यावरण व भूगोल विशेष प्रश्नसंच.",
    descriptionEn:
  ...
  },
  {
    slug: "saralseva",
    id: "SARALSEVA",
    titleMr: "सरळसेवा व गट-डी भरती मॉक टेस्ट्स",
    titleEn: "Saralseva & Group D Recruitment Tests",
    descriptionMr:
      "महाराष्ट्र विविध शासकीय विभाग सरळसेवा व गट-डी संगणकीय परीक्षांचे (CBT) सराव पेपर्स.",
    descriptionEn:
  ...
  },
  {
    slug: "pyq",
    id: "PYQ",
    titleMr: "अधिकृत PYQ (मागील वर्षांचे मूळ प्रश्नपत्रिका संच)",
    titleEn: "Official Previous Year Question Papers (PYQs)",
    descriptionMr:
      "महाराष्ट्रातील विविध स्पर्धा परीक्षांच्या मागील वर्षांचे मूळ प्रश्नपत्रिका संच कव्हर केले आहेत.",
    descriptionEn:
...
export function getCategoryBySlug(slugOrId) {
  ...
  return (
    EXAM_CATEGORIES.find(
      ...
      titleMr: `स्पर्धा परीक्षा (${target})`,
      titleEn: `Competitive Exam (${target})`,
      descriptionMr: "महाराष्ट्र स्पर्धा परीक्षांच्या ऑनलाईन मॉक चाचण्या.",
...
export function getCategorySlugFromExam(exam) {
  const slug = (exam.slug || exam.id || "").toLowerCase();
  const title = (exam.title || "").toLowerCase();
  const type = (exam.examType || "").toUpperCase();
