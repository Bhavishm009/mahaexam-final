  ...
  return (
    <div className="pb-10 pt-2 font-sans sm:pb-14 sm:pt-3">
      <div className="mx-auto max-w-7xl space-y-4 px-4 sm:px-6 lg:px-8">
        {/* Breadcrumb skeleton */}
        <div className="h-4 w-52 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-800" />
        ...
        <div className="grid grid-cols-1 gap-6 pt-2 md:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div
              key={i}
              className="glass-card flex flex-col justify-between space-y-4 rounded-3xl p-6 shadow-sm"
            >
