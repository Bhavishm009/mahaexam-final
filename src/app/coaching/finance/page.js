    ...
    <main className="min-h-screen bg-slate-50 p-6 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl font-black text-slate-900 dark:text-white">
          Coaching Payout Account
        </h1>
        <p className="mt-1 text-slate-500 dark:text-slate-400">
          Configure the account used for marketplace earnings.
        </p>
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="grid gap-3">
            <input
              ...
              className="rounded-xl border border-slate-300 bg-white p-3 text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none dark:border-slate-700 dark:bg-slate-800/80 dark:text-white"
            />
            <input
              placeholder="Email"
            ...
            <button
              onClick={save}
              className="rounded-xl bg-blue-600 py-3 font-bold text-white transition-colors hover:bg-blue-500"
            >
              Submit
            </button>
          </div>
