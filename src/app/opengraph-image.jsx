    ...
    (
      ...
      >
        ...
        >
          ...
          >
            २,७००+ दर्जेदार प्रश्न, मराठी स्पष्टीकरण, इन्स्टंट महाराष्ट्र मेरिट रँक आणि अचूक उत्तरतालिका.
          </p>
        </div>
        ...
        >
          <div style={{ display: "flex", gap: 32 }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <span style={{ fontSize: 13, color: "#64748b", fontWeight: 600 }}>१० विषयनिहाय बँक</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontSize: 24, fontWeight: 900, color: "#4ade80" }}>२७+ संपूर्ण टेस्ट</span>
              <span style={{ fontSize: 13, color: "#64748b", fontWeight: 600 }}>१००% मोफत व सराव</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontSize: 24, fontWeight: 900, color: "#c084fc" }}>राज्यस्तरीय रँक</span>
              <span style={{ fontSize: 13, color: "#64748b", fontWeight: 600 }}>रिअल-टाइम विश्लेषण</span>
            </div>
          </div>
