      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {items.map((r) => (
            <article
              key={r.id}
              className="group flex flex-col justify-between gap-5 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-blue-300 hover:shadow-md sm:p-6 md:flex-row md:items-center"
            >
              <div className="flex-1">
                ...
                <h2 className="mt-2.5 text-base font-black text-slate-900 transition group-hover:text-blue-600 sm:text-lg">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {r.examId && (
                    <Link
                      ...
                      className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 p-2.5 text-slate-700 transition hover:bg-slate-100"
