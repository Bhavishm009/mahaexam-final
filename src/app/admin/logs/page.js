  ...
  return (
    <main className="min-h-screen space-y-6 font-sans text-slate-900 transition-colors dark:text-slate-100">
      <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-300 sm:text-sm">
                Real-time tracking of all 138+ application API routes • Status codes, execution latencies,
                user roles, error diagnostics & stack traces.
              </p>
            </div>
        ...
        {/* Filter Control Bar */}
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-8 pr-3 py-2 text-xs font-medium text-slate-900 outline-none transition focus:border-blue-500 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
                />
              </div>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      className="flex cursor-pointer items-center justify-between gap-3 p-4 select-none sm:px-6"
                    >
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        {/* Endpoint Path */}
                        <span
                          className="font-mono text-xs font-bold text-slate-900 dark:text-white truncate"
                          title={route}
                        >
                          {route}
                        </span>
                        ...
                        {typeof durationMs === "number" && (
                          <span
                            className={`inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] font-mono ${getLatencyBadge(
                              durationMs,
                            )}`}
                          >
                      ...
                      <div className="flex items-center gap-3 shrink-0 text-right text-xs">
                        {/* User / Role Pill */}
                        <span className="hidden sm:inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                    ...
                    {isExpanded && (
                      <div className="border-t border-slate-100 bg-slate-50/50 p-5 dark:border-slate-800 dark:bg-slate-900/60 space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                          ...
                          <div className="rounded-2xl border border-slate-200 bg-white p-4 text-xs dark:border-slate-800 dark:bg-slate-950">
                            <h4 className="font-extrabold text-slate-900 dark:text-white flex items-center gap-1.5 mb-2">
